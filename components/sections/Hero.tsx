  ...
  return (
    <section
      ...
      style={{
        ...
        // Plain url() — universally supported on every browser including
        // Samsung Internet and older Android Chrome, which fail to parse
        // image-set() with type() descriptors and silently drop the declaration.
        // The JPEG (1.3 MB, 2560 px wide) is preloaded in layout.tsx.
